...
class SplattingAvatarOptimizer(LossBase):
    ...
    def setup_optimizer(self, optimizer_config):
        ...
        if optimizer_config.get('optim_xyz', False):
            print(f'[SplattingAvatarOptim] optim_xyz, lr={optimizer_config.optim_xyz.lr}')
        ...
        if optimizer_config.get('optim_features', False):
            print(f'[SplattingAvatarOptim] optim_features, lr={optimizer_config.optim_features.lr}')
        ...
        if optimizer_config.get('optim_opacity', False):
            print(f'[SplattingAvatarOptim] optim_opacity, lr={optimizer_config.optim_opacity.lr}')
        ...
        if optimizer_config.get('optim_scaling', False):
            print(f'[SplattingAvatarOptim] optim_scaling, lr={optimizer_config.optim_scaling.lr}')
        ...
        if optimizer_config.get('optim_rotation', False):
            print(f'[SplattingAvatarOptim] optim_rotation, lr={optimizer_config.optim_rotation.lr}')
